...
;cbb0064
;Beck_Cameron.asm
;Determines if two strings are anagrams, class help to deal with looping issue
...
.code
    main proc
        ...
        mov ebx, lengthof s1        ;(1) iterate lengthof s1 times
        ...
        CounterLoop:                ;this will increment the proper 'elements' of c1 and c2
            ...
            cmp ebx, esi            ;Breaks out of loop if last itteration (help from class)
            je BreakOut         
        ...
        BreakOut:
            ...
            mov edx, lengthof c1    ;(6)iterate lengthof c1 times
