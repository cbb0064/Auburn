...
int
read_files (int input_array[], ifstream & instream)
{
...
combine_and_sort (int array_1[], int array_1_size, int array_2[],
		  int array_2_size, int output_array[])
{
...
void
writefiles (int output_array[], int output_array_size)
{
...
cout << endl << "*** Welcome to Cam's sorting program ***\n";
...
array_1_size = read_files (array_1, instream);
  
instream.close ();
  
 
cout << "The list of " << array_1_size << " numbers in file " <<
    filename_1 << " is:\n";
...
array_2_size = read_files (array_2, instream);
  
instream.close ();
  
 
cout << "The list of " << array_2_size << " numbers in file " <<
    filename_2 << " is:\n";
...
int output_array_size =
    combine_and_sort (array_1, array_1_size, array_2, array_2_size,
		      output_array);
...
writefiles (output_array, output_array_size);
