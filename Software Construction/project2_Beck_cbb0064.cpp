...
// Status
  bool at_least_two_alive (bool aaron_alive, bool bob_alive,
			   bool charlie_alive)
{
...
int
aaron_shoots_1 (bool & bob_alive, bool & charlie_alive)
{
...
int
aaron_shoots_2 (bool & bob_alive, bool & charlie_alive)
{
...
int
bob_shoots (bool & aaron_alive, bool & charlie_alive)
{
...
int
charlie_shoots (bool & aaron_alive, bool & bob_alive)
{
...
test_duel (int strategy)
{
  
cout << "Ready to test strategy " << strategy << " (run " << total_duels <<
    " times):\n";
...
cout << "Aaron won " << a_wins << "/" << total_duels << " duels or " <<
    static_cast < double >(a_wins) / total_duels * 100 << "%\n";
  
cout << "Bob won " << b_wins << "/" << total_duels << " duels or " <<
    static_cast < double >(b_wins) / total_duels * 100 << "%\n";
  
cout << "Charlie won " << c_wins << "/" << total_duels << " duels or " <<
    static_cast < double >(c_wins) / total_duels * 100 << "%\n";
...
void
eval_strategies (int wins_1, int wins_2)
{
